                ...
                <table border="0">
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" name="nombreEstudiante" value="" placeholder="su nombre"></td>
                        </tr>
                        <tr>
                            <td><label for="documento">Latitud</label></td>
                            <td><input type="text" name="latitudEstudiante" value="" id="latitud" placeholder="latitud"></td>
                        </tr>
                        <tr>
                            <td><label for="edad">Lontitud</label></td>
                            <td><input type="text" name="longitudEstudiante" value="" id="longitud" placeholder="lontitud"></td>
                        </tr>
                    </tbody>
                </table>
