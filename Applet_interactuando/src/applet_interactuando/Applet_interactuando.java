...
public class Applet_interactuando extends Applet implements ActionListener {
Label l1, l2;
TextField t1, t2;
Button b;

public Applet_interactuando() {
l1 = new Label("Numero");   // se crea una etiqueta
t1 = new TextField(10);       // se crea un texto
