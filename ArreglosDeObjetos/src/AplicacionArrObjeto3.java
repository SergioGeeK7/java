...
public class AplicacionArrObjeto3 {
	...
	public static void ordena() throws IOException{
        ...
        public static void orderByName() throws IOException{
        
            
            
	    for (int i=0; i < arreglo.length-1; i++ ) {
	    	for (int j=i+1; j<arreglo.length; j++) {
			if (arreglo[i].obtenNombre().compareTo(arreglo[j].obtenNombre()) > 0) { // si entra el [i] va antes que el [j]
					Cuenta temp = arreglo[i];
					arreglo[i] = arreglo[j];
					arreglo[j] = temp;
				}
...
public static void main(String[] args) throws IOException {
	    ...
	    while (opcion != '0') {
	    	...
	    	System.out.println("6. Ordenando Cuentas por numero");
                System.out.println("7. Ordenando Cuentas por nombre");
	    	...
	    	switch (opcion) {
	    		...
	    		case ('6') :
	    			...
	    			break;
                        case ('7') :
	    		    System.out.println("Ordenando Cuentas por nombre");
                            orderByName();
	    			break;
	    		case ('0') :
