...
public class Applet_tomardatos extends Applet implements ActionListener { 
TextField t; 
Button b; 

// Button c = new Button ("hola");

//método constructor,donde se crean los objetos a dibujar en el applet
public Applet_tomardatos() { 
t = new TextField(5);    // se crea el objeto texto
